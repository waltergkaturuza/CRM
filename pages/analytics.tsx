...
export default function AnalyticsPage() {
  ...
  return (
    <>
      <Head>
        <title>Analytics - Intelligent CRM</title>
        <meta name="description" content="View your CRM analytics and insights" />
      </Head>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-sm text-gray-500">Charts coming soon</p>
              </div>
            </div>
            ...
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-sm text-gray-500">Trends coming soon</p>
              </div>
            </div>
          </div>
        </div>
